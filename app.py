...
if not os.path.exists(DB_PATH):
    ...
    trainer.train("chatterbot.corpus.english")  # Train the chatbot

# ==========================
# 🔹 Download the model from Hugging Face
# ==========================
MODEL_URL = "https://huggingface.co/Ahmadft/mastitis_model2.pth/resolve/main/mastitis_model2.pth"
MODEL_PATH = "mastitis_model2.pth"
...
if __name__ == "__main__":
    app.run(host="0.0.0.0", port=5000)  # Match fly.toml settings
